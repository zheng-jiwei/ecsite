...
if(cid != ""){
    ...
    get_products_by_collection_id(results, function (result) {
        ...
        for(let i = 0; i<data.length; i++){
            ...
            output.push("<div style=\"float:left\"><a href=\"/products/product.html?pid="+ pid +"\"><img src=\""+data[i].node.images.edges[0].node.src+"\" class=\"image-size\"><div><span>"+ data[i].node.priceRange.minVariantPrice.currencyCode +"</span><span>"+ data[i].node.priceRange.minVariantPrice.amount +"</span></div></a></div>");
        }
